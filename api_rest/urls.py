...
urlpatterns = [
    ...
    path('employee/update_password/', ChangeEmployeePasswordView.as_view()),
    ...
    path('extra_services/update/', UpdateExtraServiceView.as_view()),
